...
enum { OPT_HELP = 1000, OPT_PROTO, OPT_SERV, OPT_DEV, OPT_SRCIP,
       ...
       OPT_TCP, OPT_UDP, OPT_ICMP, OPT_ALL, OPT_LIST, OPT_SIMULATE, OPT_REVERSE,
       OPT_RETRANSMIT, OPT_INTERACT
};
...
static struct poptOption po[] = {
    ...
    { "simulate",     '\0', POPT_ARG_NONE,   0,            OPT_SIMULATE,    NULL, NULL },
    { "reverse",      '\0', POPT_ARG_NONE,   0,            OPT_REVERSE,     NULL, NULL },
    { "retransmit",   '\0', POPT_ARG_NONE,   0,            OPT_RETRANSMIT,  NULL, NULL },
    { "interact",     '\0', POPT_ARG_NONE,   0,            OPT_INTERACT,    NULL, NULL },
...
int parseOpt(int argc, char **argv, std::string& msg)
{
    ...
    // Default TCP flag is SYN
    if (!tcpFlags && !tcpIsNull)
	tcpFlags = TH_SYN;
